...
1. 根据条件选择一个固定点，将数组分为两个区间：跳出区间 和 结果区间 
...
=======
        ...
        while(left < right){               // 1 不同点
            int mid = left + ((right - left)/2);
            if(nums[mid] < target) left = mid + 1; // 跳出区间
            else right = mid; // 不超过
        }
...
>>>>>>> 7334b7b063221b0909daa899d13509c6e2e8919e
        ...
        while(left < right){
            ...
            if(nums[mid] > target) right = mid - 1;  // 跳出区间
            else left = mid; // 不超过
        }
        // 左端点存在，则一定存在右端点
        return {begin, right};
...
| ![image-20240312225536890](https://cdn.jsdelivr.net/gh/ZhangYuQiao326/study_nodes_pictures@main/img/image-20240312225536890.png) | [题](https://leetcode.cn/problems/peak-index-in-a-mountain-array/description/) |
...
![image-20240313232516345](https://cdn.jsdelivr.net/gh/ZhangYuQiao326/study_nodes_pictures@main/img/image-20240313232516345.png)
...
| [分割成三块子串是否为回文串](https://leetcode.cn/problems/palindrome-partitioning-iv/submissions/516675056/) | 统计所有回文串，遍历所有分三块的子串 |
|                                                              |                                      |
|                                                              |                                      |
|                                                              |                                      |
|                                                              |                                      |
