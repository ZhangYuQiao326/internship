...
void adjust(vector<int> &arr, int end, int lastTree)
{
...
{
	adjust(vec, vec.size()-1 , 0);  // 创建大根堆

	for (int i = vec.size() - 1; i >= 1; --i)
	{
		swap(vec[0], vec[i]); // 记录堆顶的最大值
		adjust(vec, i-1, 0);  // 再次将[0,i-1]内的数据构建大根堆
	}
}
```
...
>>>>>>> 2d04c828662ad8e79067902c1434a530572bea16
|                                                              |                                      |
|                                                              |                                      |
...
>>>>>>> be9cfa2f3889bfcaa572beb1066746d878d472cf
